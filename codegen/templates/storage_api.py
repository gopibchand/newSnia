...
class storageCollection(Resource):
	def __init__(self):
		self.rb = g.rest_base
		self.config = {
			'@odata.context': self.rb + '$metadata#storageCollection.storageCollection'
			'@odata.id': self.rb + 'storageCollection'
			'@odata.type': '#storageCollection.1.0.0.storageCollection'
