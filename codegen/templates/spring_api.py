...
class springCollection(Resource):
	def __init__(self):
		self.rb = g.rest_base
		self.config = {
			'@odata.context': self.rb + '$metadata#springCollection.springCollection'
			'@odata.id': self.rb + 'springCollection'
			'@odata.type': '#springCollection.1.0.0.springCollection'
